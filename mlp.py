...
xgb_FP_max_depth = 3
#############################################################################
mlp_basic_hidden_layer_sizes = 100
mlp_basic_max_iter = 5000
mlp_basic_alpha = 0.1

mlp_rdkit_hidden_layer_sizes = 1000
mlp_rdkit_max_iter = 1000
mlp_rdkit_alpha = 0.1

mlp_FP_hidden_layer_sizes = 5000
mlp_FP_max_iter = 1000
mlp_FP_alpha = 0.01
############################################################################
...
mlp_model_basic = MLPClassifier(hidden_layer_sizes=mlp_basic_hidden_layer_sizes,max_iter=mlp_basic_max_iter,alpha=mlp_basic_alpha)
#####################Models Training Using Basic Molecular Descriptors: 4-MLP#####################
mlp_basic = mlp_model_basic.fit(X_train_basic,  y_train.values.ravel())
mlp_basic_predictions = mlp_basic.predict(X_test_basic)

mlp_basic_classify_training_score = mlp_basic.score(X_train_basic,  y_train.values.ravel())
mlp_basic_classify_validation_score = mlp_basic.score(X_test_basic, y_test)
mlp_basic_F1_score_micro = metrics.f1_score(y_test,mlp_basic_predictions,average="micro")
mlp_basic_F1_score_macro = metrics.f1_score(y_test,mlp_basic_predictions,average="macro")
mlp_basic_mcc_score = metrics.matthews_corrcoef(y_test,mlp_basic_predictions)

print ("The Training Score For MLP Trained on Basic Molecular Descriptors Is: ", mlp_basic_classify_training_score)
print ("The Validation Score For MLP Trained on Basic Molecular Descriptors Is: ", mlp_basic_classify_validation_score)
print ("The Micro-F1 Score For MLP Trained on Basic Molecular Descriptors Is: ", mlp_basic_F1_score_micro)
print ("The Macro-F1 Score For MLP Trained on Basic Molecular Descriptors Is: ", mlp_basic_F1_score_macro)
print ("The Matthews correlation coefficient Score For The MLP Trained on Basic Molecular Descriptors Is: ", mlp_basic_mcc_score)
############################################################################################################################################
#number_of_classes = y_train.nunique()
y_train_classify_one_hot_basic = tf.keras.utils.to_categorical(y_train.values.ravel())
y_test_classify_one_hot_basic = tf.keras.utils.to_categorical(y_test.values.ravel())
number_of_classes=y_train_classify_one_hot_basic.shape[1]
dl_model_basic = tf.keras.Sequential()
dl_model_basic.add(tf.keras.layers.Dense(64, input_dim=4, activation='relu'))
dl_model_basic.add(tf.keras.layers.Dropout(0.5))
dl_model_basic.add(tf.keras.layers.Dense(128, activation='relu'))
dl_model_basic.add(tf.keras.layers.Dropout(0.5))
dl_model_basic.add(tf.keras.layers.Dense(number_of_classes, activation='softmax'))
#optim = keras.optimizers.nadam(lr=0.001)
optim = tf.keras.optimizers.Nadam(learning_rate=0.001)
dl_model_basic.compile(optimizer=optim, loss="categorical_crossentropy", metrics=['accuracy'])
dl_model_basic.fit(X_train_basic,y_train_classify_one_hot_basic,epochs=NEPOCHS)
deep_learning_model_training_score_basic = (dl_model_basic.evaluate(X_train_basic, y_train_classify_one_hot_basic,verbose=0))[1]
deep_learning_model_validation_score_basic = (dl_model_basic.evaluate(X_test_basic, y_test_classify_one_hot_basic,verbose=0))[1]


dl_model_basic_prediction = dl_model_basic.predict(X_test_basic)
dl_model_basic_predicted = np.argmax(dl_model_basic_prediction, axis=1)

dl_basic_F1_score_micro = metrics.f1_score(y_test,dl_model_basic_predicted,average="micro")
dl_basic_F1_score_macro = metrics.f1_score(y_test,dl_model_basic_predicted,average="macro")
dl_basic_mcc_score = metrics.matthews_corrcoef(y_test,dl_model_basic_predicted)

dl_model_basic_cm = confusion_matrix(np.argmax(y_test_classify_one_hot_basic, axis=1), dl_model_basic_predicted)
dl_model_basic_report = classification_report(np.argmax(y_test_classify_one_hot_basic, axis=1), dl_model_basic_predicted )

print ("The Macro-F1 score For The DeepLearningClassifierBasic Is: ", dl_basic_F1_score_macro)
print ("The Micro-F1 score For The DeepLearningClassifierBasic Is: ", dl_basic_F1_score_micro)
print ("The Matthews correlation coefficient score For The DeepLearningClassifierBasic Is: ", dl_basic_mcc_score)
######################free some memory################
del X_train_basic
del X_test_basic
del y_train_classify_one_hot_basic
del y_test_classify_one_hot_basic
...
############################################################################################################################################
############################################################################################################################################
mlp_model_rdkit = MLPClassifier(hidden_layer_sizes=mlp_rdkit_hidden_layer_sizes,max_iter=mlp_rdkit_max_iter,alpha=mlp_rdkit_alpha)
#####################Models Training Using RDKIT Molecular Descriptors: 9-MLP#####################
mlp_rdkit = mlp_model_rdkit.fit(X_train_rdkit,  y_train.values.ravel())
mlp_rdkit_predictions = mlp_rdkit.predict(X_test_rdkit)

mlp_rdkit_classify_training_score = mlp_rdkit.score(X_train_rdkit,  y_train.values.ravel())
mlp_rdkit_classify_validation_score = mlp_rdkit.score(X_test_rdkit, y_test)
mlp_rdkit_F1_score_micro = metrics.f1_score(y_test,mlp_rdkit_predictions,average="micro")
mlp_rdkit_F1_score_macro = metrics.f1_score(y_test,mlp_rdkit_predictions,average="macro")
mlp_rdkit_mcc_score = metrics.matthews_corrcoef(y_test,mlp_rdkit_predictions)

print ("The Training Score For MLP Trained on RDKIT Molecular Descriptors Is: ", mlp_rdkit_classify_training_score)
print ("The Validation Score For MLP Trained on RDKIT Molecular Descriptors Is: ", mlp_rdkit_classify_validation_score)
print ("The Micro-F1 Score For MLP Trained on RDKIT Molecular Descriptors Is: ", mlp_rdkit_F1_score_micro)
print ("The Macro-F1 Score For MLP Trained on RDKIT Molecular Descriptors Is: ", mlp_rdkit_F1_score_macro)
print ("The Matthews correlation coefficient Score For MLP Trained on RDKIT Molecular Descriptors Is: ", mlp_rdkit_mcc_score)
############################################################################################################################################
###########################DeepLearning Model Training On: 10- RDKIT Molecular Descriptors#########################
#number_of_classes = y_train.nunique()
y_train_classify_one_hot_rdkit = tf.keras.utils.to_categorical(y_train.values.ravel())
y_test_classify_one_hot_rdkit = tf.keras.utils.to_categorical(y_test.values.ravel())
number_of_classes=y_train_classify_one_hot_rdkit.shape[1]
dl_model_rdkit = tf.keras.Sequential()
dl_model_rdkit.add(tf.keras.layers.Dense(512, input_dim=111, activation='relu'))
dl_model_rdkit.add(tf.keras.layers.Dropout(0.5))
dl_model_rdkit.add(tf.keras.layers.Dense(1024, activation='relu'))
dl_model_rdkit.add(tf.keras.layers.Dropout(0.5))
dl_model_rdkit.add(tf.keras.layers.Dense(number_of_classes, activation='softmax'))
#optim = keras.optimizers.nadam(lr=0.001)
optim = tf.keras.optimizers.Nadam(learning_rate=0.001)
dl_model_rdkit.compile(optimizer=optim, loss="categorical_crossentropy", metrics=['accuracy'])
dl_model_rdkit.fit(X_train_rdkit,y_train_classify_one_hot_rdkit,epochs=NEPOCHS)

deep_learning_model_training_score_rdkit = (dl_model_rdkit.evaluate(X_train_rdkit, y_train_classify_one_hot_rdkit,verbose=0))[1]
deep_learning_model_validation_score_rdkit = (dl_model_rdkit.evaluate(X_test_rdkit, y_test_classify_one_hot_rdkit,verbose=0))[1]

dl_model_rdkit_prediction = dl_model_rdkit.predict(X_test_rdkit)
dl_model_rdkit_predicted = np.argmax(dl_model_rdkit_prediction, axis=1)

dl_rdkit_F1_score_micro = metrics.f1_score(y_test,dl_model_rdkit_predicted,average="micro")
dl_rdkit_F1_score_macro = metrics.f1_score(y_test,dl_model_rdkit_predicted,average="macro")
dl_rdkit_mcc_score = metrics.matthews_corrcoef(y_test,dl_model_rdkit_predicted)

dl_model_rdkit_cm = confusion_matrix(np.argmax(y_test_classify_one_hot_rdkit, axis=1), dl_model_rdkit_predicted)
dl_model_rdkit_report = classification_report(np.argmax(y_test_classify_one_hot_rdkit, axis=1), dl_model_rdkit_predicted )

print ("The Macro-F1 score For The DeepLearningClassifierRDKIT Is: ", dl_rdkit_F1_score_macro)
print ("The Micro-F1 score For The DeepLearningClassifierRDKIT Is: ", dl_rdkit_F1_score_micro)
print ("The Matthews correlation coefficient score For The DeepLearningClassifierRDKIT Is: ", dl_rdkit_mcc_score)

######################free some memory################
del X_train_rdkit
del X_test_rdkit
del y_train_classify_one_hot_rdkit
del y_test_classify_one_hot_rdkit
...
############################################################################################################################################
############################################################################################################################################
mlp_model_FP = MLPClassifier(hidden_layer_sizes=mlp_FP_hidden_layer_sizes,max_iter=mlp_FP_max_iter,alpha=mlp_FP_alpha)
#####################Models Training Using RDKIT Molecular FingerPrints: 14-MLP#####################
mlp_FP = mlp_model_FP.fit(np.vstack(X_train_FP.iloc[:,0]),  y_train.values.ravel())
mlp_FP_predictions = mlp_FP.predict(np.vstack(X_test_FP.iloc[:,0]))

mlp_FP_classify_training_score = mlp_FP.score(np.vstack(X_train_FP.iloc[:,0]),  y_train.values.ravel())
mlp_FP_classify_validation_score = mlp_FP.score(np.vstack(X_test_FP.iloc[:,0]), y_test)
mlp_FP_F1_score_micro = metrics.f1_score(y_test,mlp_FP_predictions,average="micro")
mlp_FP_F1_score_macro = metrics.f1_score(y_test,mlp_FP_predictions,average="macro")
mlp_FP_mcc_score = metrics.matthews_corrcoef(y_test,mlp_FP_predictions)

print ("The Training Score For MLP Trained on RDKIT Molecular FingerPrints Is: ", mlp_FP_classify_training_score)
print ("The Validation Score For MLP Trained on RDKIT Molecular FingerPrints Is: ", mlp_FP_classify_validation_score)
print ("The Micro-F1 Score For MLP Trained on RDKIT Molecular FingerPrints Is: ", mlp_FP_F1_score_micro)
print ("The Macro-F1 Score For MLP Trained on RDKIT Molecular FingerPrints Is: ", mlp_FP_F1_score_macro)
print ("The Matthews correlation coefficient score For MLP Trained on RDKIT Molecular FingerPrints Is: ", mlp_FP_mcc_score)
############################################################################################################################################
############################################################################################################################################
###########################DeepLearning Model Training On: 15- RDKIT Molecular FingerPrints#########################
#number_of_classes = y_train.nunique()
y_train_classify_one_hot_FP = tf.keras.utils.to_categorical(y_train.values.ravel())
y_test_classify_one_hot_FP = tf.keras.utils.to_categorical(y_test.values.ravel())
number_of_classes=y_train_classify_one_hot_FP.shape[1]
dl_model_FP = tf.keras.Sequential()
dl_model_FP.add(tf.keras.layers.Dense(2048, input_dim=2048, activation='relu'))
dl_model_FP.add(tf.keras.layers.Dropout(0.5))
dl_model_FP.add(tf.keras.layers.Dense(2048, activation='relu'))
dl_model_FP.add(tf.keras.layers.Dropout(0.5))
dl_model_FP.add(tf.keras.layers.Dense(number_of_classes, activation='softmax'))
#optim = keras.optimizers.nadam(lr=0.001)
optim = tf.keras.optimizers.Nadam(learning_rate=0.001)
dl_model_FP.compile(optimizer=optim, loss="categorical_crossentropy", metrics=['accuracy'])
dl_model_FP.fit(np.vstack(X_train_FP.iloc[:,0]),y_train_classify_one_hot_FP,epochs=NEPOCHS)

deep_learning_model_training_score_FP = (dl_model_FP.evaluate(np.vstack(X_train_FP.iloc[:,0]), y_train_classify_one_hot_FP,verbose=0))[1]
deep_learning_model_validation_score_FP = (dl_model_FP.evaluate(np.vstack(X_test_FP.iloc[:,0]), y_test_classify_one_hot_FP,verbose=0))[1]

dl_model_FP_prediction = dl_model_FP.predict(np.vstack(X_test_FP.iloc[:,0]))
dl_model_FP_predicted = np.argmax(dl_model_FP_prediction, axis=1)

dl_FP_F1_score_micro = metrics.f1_score(y_test,dl_model_FP_predicted,average="micro")
dl_FP_F1_score_macro = metrics.f1_score(y_test,dl_model_FP_predicted,average="macro")
dl_FP_mcc_score = metrics.matthews_corrcoef(y_test,dl_model_FP_predicted)

dl_model_FP_cm = confusion_matrix(np.argmax(y_test_classify_one_hot_FP, axis=1), dl_model_FP_predicted)
dl_model_FP_report = classification_report(np.argmax(y_test_classify_one_hot_FP, axis=1), dl_model_FP_predicted )

print ("The Macro-F1 score For The DeepLearningClassifierFP Is: ", dl_FP_F1_score_macro)
print ("The Micro-F1 score For The DeepLearningClassifierFP Is: ", dl_FP_F1_score_micro)
print ("The Matthews correlation coefficient score For The DeepLearningClassifierFP Is: ", dl_FP_mcc_score)

######################free some memory################
del y_train_classify_one_hot_FP
del y_test_classify_one_hot_FP
del X_train_FP
del X_test_FP
...
"mlp_basic_classify_training_score",
"xgb_rdkit_classify_training_score", 
"mlp_rdkit_classify_training_score", 
"xgb_FP_classify_training_score",
"mlp_FP_classify_training_score",
...
"mlp_basic_classify_validation_score",
"xgb_rdkit_classify_validation_score",
"mlp_rdkit_classify_validation_score",
"xgb_FP_classify_validation_score",
"mlp_FP_classify_validation_score",
...
"mlp_basic_F1_score_macro",
"xgb_rdkit_F1_score_macro",
"mlp_rdkit_F1_score_macro",
"xgb_FP_F1_score_macro",
"mlp_FP_F1_score_macro",
"dl_basic_F1_score_macro",
"dl_rdkit_F1_score_macro",
"dl_FP_F1_score_macro",
"xgb_basic_F1_score_micro",
"mlp_basic_F1_score_micro",
"xgb_rdkit_F1_score_micro",
"mlp_rdkit_F1_score_micro",
"xgb_FP_F1_score_micro",
"mlp_FP_F1_score_micro",
"dl_basic_F1_score_micro",
"dl_rdkit_F1_score_micro",
"dl_FP_F1_score_micro",
"mlp_basic_mcc_score",
"dl_basic_mcc_score", 
"mlp_rdkit_mcc_score",
"dl_rdkit_mcc_score", 
...
l4 = [mlp_basic_classify_training_score,
np.nan,  
mlp_rdkit_classify_training_score, 
np.nan,
deep_learning_model_training_score_basic,
...
l6 = [mlp_basic_classify_training_score,
deep_learning_model_training_score_basic,
np.nan,
mlp_basic_classify_validation_score,
deep_learning_model_validation_score_basic,
...
l10 = [deep_learning_model_training_score_FP,
np.nan,
mlp_FP_classify_validation_score,
deep_learning_model_validation_score_FP,
np.nan,
...
filename = 'mlp_rdkit_classify_model.sav'
pickle.dump(mlp_rdkit, open(filename, 'wb'))

model_json = dl_model_rdkit.to_json()
with open("dl_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
dl_model_rdkit.save_weights("dl_model.h5")
...
filename = 'mlp_rdkit_classify_fp.sav'
pickle.dump(mlp_FP, open(filename, 'wb'))

model_json = dl_model_FP.to_json()
with open("dl_model_fp.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
dl_model_FP.save_weights("dl_model_fp.h5")
...
mlp_rdkit_classify = pickle.load(open("mlp_rdkit_classify_model.sav", 'rb'))
mlp_rdkit_classify_prediction = mlp_rdkit_classify.predict(drug_bank_pred_scaled)
mlp_rdkit_classify_prediction_proba = mlp_rdkit_classify.predict_proba(drug_bank_pred_scaled)
del mlp_rdkit_classify
print ("mlp_rdkit_classify prediction made")
...
json_file.close()
dl_model = tf.keras.model_from_json(loaded_model_json)
# load weights into new model
dl_model.load_weights("dl_model.h5")
print("Loaded model from disk")
dl_model_prediction = dl_model.predict_classes(drug_bank_pred_scaled)
dl_model_prediction_proba = dl_model.predict(drug_bank_pred_scaled)
del dl_model
...
loaded_model_json = json_file.read()
json_file.close()
dl_model_fp = tf.keras.model_from_json(loaded_model_json)
# load weights into new model
...
drug_bank_df_selected_cols_featurized_filtered_subset['prediction_class_mlp_rdkit_classify_prediction'] = mlp_rdkit_classify_prediction
drug_bank_df_selected_cols_featurized_filtered_subset['prediction_class_mlp_rdkit_classify_prediction_proba'] = mlp_rdkit_classify_prediction_proba.max()
...
drug_bank_df_selected_cols_featurized_filtered_subset['prediction_class_mlp_rdkit_classify_fp_prediction'] = mlp_rdkit_classify_fp_prediction
drug_bank_df_selected_cols_featurized_filtered_subset['prediction_class_mlp_rdkit_classify_fp_prediction_proba'] = mlp_rdkit_classify_fp_prediction_proba.max()

drug_bank_df_selected_cols_featurized_filtered_subset['prediction_class_dl_model_prediction'] = dl_model_prediction
drug_bank_df_selected_cols_featurized_filtered_subset['prediction_class_dl_model_prediction_proba'] = dl_model_prediction_proba.max()
