...
svm_model_basic  = OneVsRestClassifier(SVC(kernel=svm_basic_kernel, probability=True,C=svm_basic_c), n_jobs=-1)
#svm_model_basic  = OneVsRestClassifier(SVC(kernel=svm_basic_kernel, probability=True,cache_size=1000,C=svm_basic_c), n_jobs=-1)
#svm_model_basic = SVC(C=100,cache_size=16000)
#####################Models Training Using Basic Molecular Descriptors: 3-SVM#####################
svm_basic = svm_model_basic.fit(X_train_basic,  y_train.values.ravel())
svm_basic_predictions = svm_basic.predict(X_test_basic)

svm_basic_classify_training_score = svm_basic.score(X_train_basic,  y_train.values.ravel())
svm_basic_classify_validation_score = svm_basic.score(X_test_basic, y_test)
svm_basic_F1_score_micro = metrics.f1_score(y_test,svm_basic_predictions,average="micro")
svm_basic_F1_score_macro = metrics.f1_score(y_test,svm_basic_predictions,average="macro")
svm_basic_mcc_score = metrics.matthews_corrcoef(y_test,svm_basic_predictions)

print ("The Training Score For SVM Trained on Basic Molecular Descriptors Is: ", svm_basic_classify_training_score)
print ("The Validation Score For SVM Trained on Basic Molecular Descriptors Is: ", svm_basic_classify_validation_score)
print ("The Micro-F1 Score For SVM Trained on Basic Molecular Descriptors Is: ", svm_basic_F1_score_micro)
print ("The Macro-F1 Score For SVM Trained on Basic Molecular Descriptors Is: ", svm_basic_F1_score_macro)
print ("The Matthews correlation coefficient Score For The SVM Trained on Basic Molecular Descriptors Is: ", svm_basic_mcc_score)
############################################################################################################################################
############################################################################################################################################
...
############################################################################################################################################
############################################################################################################################################
svm_model_FP = OneVsRestClassifier(SVC(kernel=svm_FP_kernel, probability=True,cache_size=1000,C=svm_FP_c))
#svm_model_FP = SVC(C=100,cache_size=16000)
#####################Models Training Using RDKIT Molecular FingerPrints: 13-SVM#####################
svm_FP = svm_model_FP.fit(np.vstack(X_train_FP.iloc[:,0]),  y_train.values.ravel())
svm_FP_predictions = svm_FP.predict(np.vstack(X_test_FP.iloc[:,0]))

svm_FP_classify_training_score = svm_FP.score(np.vstack(X_train_FP.iloc[:,0]),  y_train.values.ravel())
svm_FP_classify_validation_score = svm_FP.score(np.vstack(X_test_FP.iloc[:,0]), y_test)
svm_FP_F1_score_micro = metrics.f1_score(y_test,svm_FP_predictions,average="micro")
svm_FP_F1_score_macro = metrics.f1_score(y_test,svm_FP_predictions,average="macro")
svm_FP_mcc_score = metrics.matthews_corrcoef(y_test,svm_FP_predictions)

print ("The Training Score For SVM Trained on RDKIT Molecular FingerPrints Is: ", svm_FP_classify_training_score)
print ("The Validation Score For SVM Trained on RDKIT Molecular FingerPrints Is: ", svm_FP_classify_validation_score)
print ("The Micro-F1 Score For SVM Trained on RDKIT Molecular FingerPrints Is: ", svm_FP_F1_score_micro)
print ("The Macro-F1 Score For SVM Trained on RDKIT Molecular FingerPrints Is: ", svm_FP_F1_score_macro)
print ("The Matthews correlation coefficient Score For SVM Trained on RDKIT Molecular FingerPrints Is: ", svm_FP_mcc_score)
############################################################################################################################################
############################################################################################################################################
############################################################################################################################################
...
"svm_basic_classify_training_score",
...
"svm_basic_classify_validation_score",
...
l4 = [svm_basic_classify_training_score,
np.nan, 
svm_rdkit_classify_training_score, 
np.nan,
svm_FP_classify_training_score,
...
l6 = [svm_basic_classify_training_score,
np.nan,
svm_basic_classify_validation_score,
np.nan,
svm_basic_F1_score_macro,
...
l10 = [svm_FP_classify_training_score,
np.nan,
svm_FP_classify_validation_score,
np.nan,
svm_FP_F1_score_macro,
...
pickle.dump(svm_FP, open(filename, 'wb'))
