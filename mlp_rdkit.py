...
###############################################################
####Save Models Scores
l3 = ["mlp_rdkit_classify_training_score", 
...
scoring_matrix_concat = pd.concat([rdkit_molec_desc_df,rdkit_molec_FP_df],axis=1,ignore_index=True)
...
index_list = ["mlp_classify_training_score", 
